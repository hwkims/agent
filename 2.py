...
ACTION_MAPPING = {
    ...
    "scroll": lambda clicks: pyautogui.scroll(int(clicks)),  # duration 제거
    "wait": lambda seconds: time.sleep(float(seconds)),  # duration 제거
}
